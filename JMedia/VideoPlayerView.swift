...
open class VideoPlayerView: UIView {
    ...
    let pausePlayButton: UIButton = {
        ...
        button.setImage(#imageLiteral(resourceName: "ic_lapp_play.png").withRenderingMode(.alwaysOriginal), for: .normal)
    ...
    fileprivate func pauseVideo() {
        player?.pause()
        pausePlayButton.setImage(#imageLiteral(resourceName: "ic_lapp_play.png").withRenderingMode(.alwaysOriginal), for: .normal)
    }
